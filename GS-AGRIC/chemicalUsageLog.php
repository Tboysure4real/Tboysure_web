...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
        ...
        if(isset($_POST['chemName'])){
			$db->query("insert into chemicallog(chemid,mysqldate,chemName,place,mixer,conc,supervisor,remark) 
            values('$chemid','$mysqldate','$chemName','$place','$mixer','$conc','$supervisor','$remark')"); 
			
         
                        $msg="Chemical Log Added successfully Ref: ". $_POST['chemName']."" ;
				header("Location: chemicalUsageLog.php?msg=$msg");
            }
							}
                        }
...
jAlert('<?php echo  $msg; ?>', 'MITCHELLE AGROTECH');
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					...
					<li><a href="view_chemicalUsageLog.php">View Chemical Usage Log </a></li>
					<li><a href="print_chemical_log1.php">Print Chemical Usage Log </a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Add Chemical Usage Log</h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                               <?php
					  $max = $db->maxOfAll("id", "chemicallog");
					  $max=$max+1;
					  $autoid="CHEM ".$max."";
                     ...
                     <tr><td>Chem ID:</td>
                      <!--<td><input name="stockid" type="text" id="stockid" maxlength="200"  class="round default-width-input" style="width:130px" readOnly="true" value="<?php echo $autoid ?>" /></td>
                                        -->
                      <td><input name="chemid" type="text" id="chemid"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" style="width:130px"/></td>
                      ...
                      <td><span class="man"></span>Chemical Name:</td>
                      <td><input name="chemName" placeholder="ENTER CHEMICAL NAME" type="text" id="chemName"  maxlength="200"  class="round default-width-input"  /></td>
                     
                      <td><span class="man">*</span>Where Applied:</td>
                      <td><input name="place" placeholder="ENTER WHERE CHEMICAL IS BEING APPLIED" type="text" id="place" maxlength="200"  class="round default-width-input"  style="width:270px" value="<?php echo $place; ?>" /></td>
                    ...
                    <tr>
                         <td>Mixed BY </td>
                      <td><input name="mixer" placeholder="ENTER THE MIXER'S NAME" type="text" id="mixer" maxlength="50"  class="round default-width-input" 
					  value="<?php echo $mixer; ?>" /></td>
                        
                        <td>Concentration mixed Proportion </td>
                      <td><input name="conc" placeholder="ENTER CHEMICAL CONC. PROPORTION"type="text" id="conc" maxlength="200"   class="round default-width-input" 
					  value="<?php echo $conc; ?>" /></td>
                        
                      <tr> <td>Supervised BY </td>
                      <td><input name="supervisor" placeholder="ENTER THE MIXER'S NAME" type="text" id="supervisor" maxlength="20"  class="round default-width-input" 
					  value="<?php echo $supervisor; ?>" /></td>
                      <td>Remark</td>
