	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<div id="login-intro" class="fl">
				...
				<h1>Login to GS AGRIC Dashboard</h1>
				<h5>Enter your credentials below</h5>
			
			<marquee style="color:blue;">QUALITY ASSURANCE APPLICATION</marquee>
			</div> <!-- login-intro -->
        ...
        <!--<h1 style="margin-left: 440px; font-family: Georgia;    font-weight: bold; font-size:20px; color: #0060BF">GS AGRIC QUALITY CONTROL &nbsp;&nbsp;&nbsp;</h1>-->
	
	<!-- MAIN CONTENT -->
	
         <!--<img src="upload/Hafiz Super Store.png" >-->
