...
include_once("init.php");
	if(isset($_POST['housId'])){
					$_POST = $gump->sanitize($_POST);
					$gump->validation_rules(array(

						'housId' => 'required|max_len,100|min_len,3',                      
                       'surrounding' => 'required|max_len,100|min_len,3',
                        'maleCloak'      =>    'required|max_len,100|min_len,3',
                        'femaleCloak'     =>  'required|max_len,100|min_len,3',
                        'maleToilet'    =>  'required|max_len,100|min_len,3',
                        'femaleToilet'    =>  'required|max_len,100|min_len,3',
                        'offices'    =>  'required|max_len,100|min_len,3',
                        'remark'    =>  'required|max_len,100|min_len,3'
                 ));
				
					$gump->filter_rules(array(
                    'housId'     => 'trim|sanitize_string|mysqli_escape',
                    'surrounding'         => 'trim|sanitize_string|mysqli_escape',
                   'maleCloak'        => 'trim|sanitize_string|mysqli_escape',
                   'femaleCloak'     => 'trim|sanitize_string|mysqli_escape',
                   'maleToilet'            => 'trim|sanitize_string|mysqli_escape',
                   'femaleToilet'            => 'trim|sanitize_string|mysqli_escape',
                   'offices'            => 'trim|sanitize_string|mysqli_escape',
                   ...
                   $remark  = "";
                    ...
                    if($validated_data === false) {
							...
							$maleCloak=$_POST['maleCloak'];
							$femaleCloak=($_POST['femaleCloak']);
							$maleToilet=($_POST['maleToilet']);
                            $femaleToilet=($_POST['femaleToilet']);  
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
        ...
        if(isset($_POST['housId'])){
			$db->query("insert into housekeeping(housId,mysqldate,surrounding,maleCloak,femaleCloak,maleToilet,femaleToilet,offices,remark) 
            values('$housId','$mysqldate','$surrounding','$maleCloak','$femaleCloak','$maleToilet','$femaleToilet','$offices','$remark')"); 
		
                        $msg="Blast Freezer Section Added successfully Ref: ". $_POST['housId']."" ;
				header("Location: houseKeeping.php?msg=$msg");
            }
							}
                        }
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>Housekeeping</h3>
				<ul>
					<li><a href="housekeeping.php">Add Housekeeping Form</a></li>
					<li><a href="view_housekeeping.php">View Housekeeping Record </a></li>
                    <li><a href="print_housekeeping1.php">print Housekeeping Record </a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">HOUSEKEEPING REPORT </h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row gold">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                               <?php
					  $max = $db->maxOfAll("id", "housekeeping");
					  $max=$max+1;
					  $autoid="Hous ".$max."";
                      ...
                      <td>Hous ID:</td>
                      <td><input name="housId" type="text" id="housId"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" /></td>
      ...
      <tr>                  
       ...
       <td><input name="surrounding" placeholder="" type="checkbox" id="surrounding" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="surrounding" placeholder="" type="checkbox" id="surrounding" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       </tr>
       <tr>
       <td>&nbsp; </td>
       <td>&nbsp; </td>
        ...
        <tr>
       <td>Male Cloak Room:</td>
       <td><input name="maleCloak" placeholder="" type="checkbox" id="maleCloak" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="maleCloak" placeholder="" type="checkbox" id="maleCloak" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       </tr>
       <tr>
       <td>&nbsp; </td>
       <td>&nbsp; </td>
       ...
       <tr>
      <td>Female Cloak Room:</td>
       <td><input name="femaleCloak" placeholder="" type="checkbox" id="femaleCloak" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="femaleCloak" placeholder="" type="checkbox" id="femaleCloak" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
      
     <tr>
      <td>Male Toilet</td>
      <td><input name="maleToilet" placeholder="" type="checkbox" id="maleToilet" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="maleToilet" placeholder="" type="checkbox" id="maleToilet" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
             </tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
       </tr>
       <tr>
      <td>Female Toilet</td>
      <td><input name="femaleToilet" placeholder="" type="checkbox" id="femaleToilet" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="femaleToilet" placeholder="" type="checkbox" id="femaleToilet" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
       </tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
       </tr>
       <td>Offices</td>
      <td><input name="offices" placeholder="" type="checkbox" id="offices" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="offices" placeholder="" type="checkbox" id="offices" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
       </tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
       </tr>
