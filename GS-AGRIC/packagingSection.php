...
include_once("init.php");
	if(isset($_POST['pckgId'])){
					$_POST = $gump->sanitize($_POST);
					$gump->validation_rules(array(

						'pckgId' => 'required|max_len,100|min_len,3',                      
                        'chlorinDos' => 'required|max_len,100|min_len,3',
                        'weighingMachine' => 'required|max_len,100|min_len,3',
                        'weighingMachine'      =>    'required|max_len,100|min_len,3',
                        'polyclipMachine'     =>  'required|max_len,100|min_len,3',
                        'remark'    =>  'required|max_len,100|min_len,3'
					));
				
					$gump->filter_rules(array(
                    'pckgId'     => 'trim|sanitize_string|mysqli_escape',
                    'weighingMachine'         => 'trim|sanitize_string|mysqli_escape',
                   'drainer'        => 'trim|sanitize_string|mysqli_escape',
                   'weighingMachine'     => 'trim|sanitize_string|mysqli_escape',
                   'polyclipMachine'     => 'trim|sanitize_string|mysqli_escape',
                  ...
                  $pckgId   = "";
                   ...
                   $remark  = ""; 
                    ...
                    if($validated_data === false) {
							...
							$drainer=$_POST['drainer'];
                            $workingTable=($_POST['workingTable']);
							$polyclipMachine=($_POST['polyclipMachine']);
							$remark=($_POST['remark']);
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
        ...
        if(isset($_POST['pckgId'])){
			$db->query("insert into packagingsection(pckgId,mysqldate,weighingMachine,drainer,workingTable,polyclipMachine,remark) 
            values('$pckgId','$mysqldate','$weighingMachine','$drainer','$workingTable','$polyclipMachine','$remark')"); 
		
                        $msg="Packaging Section successfully Ref: ". $_POST['pckgId']."" ;
				header("Location: packagingsection.php?msg=$msg");
            }
							}
                        }
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>Packaging/Cut Ups</h3>
				<ul>
					<li><a href="packagingSection.php">Add Packaging/Cut Ups</a></li>
					<li><a href="view_packaging.php">View Packaging/Cut Ups </a></li>
                    <li><a href="print_packaging1.php">Print Packaging/Cut Ups </a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Add Packaging/Cut Ups</h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                               <?php
					  $max = $db->maxOfAll("id", "packagingsection");
					  $max=$max+1;
					  $autoid="Pckg ".$max."";
                      ...
                      <!--<td><input name="stockid" type="text" id="stockid" maxlength="200"  class="round default-width-input" style="width:130px" readOnly="true" value="<?php echo $autoid ?>" /></td>
                                        -->
                      <td><input name="pckgId" type="text" id="pckgId"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" /></td>
      ...
      <tr>                  
       ...
       <td><input name="weighingMachine" placeholder="" type="checkbox" id="weighingMachine" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="weighingMachine" placeholder="" type="checkbox" id="weighingMachine" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       </tr>
       <tr>
       <td>&nbsp; </td>
       <td>&nbsp; </td>
        ...
        <tr>
       <td>Drainer:</td>
       <td><input name="drainer" placeholder="" type="checkbox" id="drainer" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="drainer" placeholder="" type="checkbox" id="drainer" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       </tr>
       <tr>
       <td>&nbsp; </td>
       <td>&nbsp; </td>
       ...
       <tr>
       <td>Working Table:</td>
       <td><input name="workingTable" placeholder="" type="checkbox" id="workingTable" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="workingTable" placeholder="" type="checkbox" id="workingTable" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td></tr>
      <td>&nbsp; </td>
       <td>&nbsp; </td>
       
       <tr>
      <td>Wall:</td>
       <td><input name="polyclipMachine" placeholder="" type="checkbox" id="polyclipMachine" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
       <td><input name="polyclipMachine" placeholder="" type="checkbox" id="polyclipMachine" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
      
     <tr>
      <td>Remark/Corrective action</td>
       <td><textarea name="remark" placeholder="ENTER REMARKS "cols="15" class="round" style="width:200px "><?php echo $remark; ?></textarea></td>
       </tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
       </tr>
