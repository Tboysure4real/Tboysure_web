		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					...
					<li><a href="print_blastFreezer1.php">Print Blast Freezer Section</a></li>
...
$SQL = "SELECT DISTINCT(stockid) FROM  slaughterline";

if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$SQL = "SELECT DISTINCT(stockid)FROM  purchase WHERE stockid LIKE '%".$_POST['searchtxt']."%'";

}

	$tbl_name="slaughterline";		//your table name
	...
	*/
	...
	$query = "SELECT COUNT(DISTINCT slauId) as num FROM $tbl_name";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$query = "SELECT COUNT(DISTINCT slauId) as num FROM slaughterline WHERE name LIKE '%".$_POST['searchtxt']."%' ";
	...
	$targetpage = "view_slaughteringLine.php"; 	//your file name  (the name of this file)
...
$sql = "SELECT * FROM blastfreezer WHERE name LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		if ($page > 1) 
			...
			$pagination.= "<a href=\"view_blastFreezer.php?page=$prev&limit=$limit\" class=my_pagination >Previous</a>";
		...
		{	
...

			{
				...
				if ($counter == $page)
					...
					$pagination.= "<a href=\"view_blastFreezer.php?page=$counter&limit=$limit\" class=my_pagination>$counter</a>";					
...

		{
...

			{
				...
				$pagination.= "<a href=\"view_blastFreezer.php?page=$lpm1&limit=$limit\" class=my_pagination>$lpm1</a>";

				$pagination.= "<a href=\"view_blastFreezer.php?page=$lastpage&limit=$limit\" class=my_pagination>$lastpage</a>";		
...

			{
				...
				$pagination.= "<a href=\"view_blastFreezer.php?page=1&limit=$limit\" class=my_pagination>1</a>";

				$pagination.= "<a href=\"view_blastFreezer.php?page=2&limit=$limit\" class=my_pagination>2</a>";
		...
		if ($page < $counter - 1) 
			...
			$pagination.= "<a href=\"view_blastFreezer.php?page=$next&limit=$limit\" class=my_pagination>Next</a>";
