	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					<li><a href="slaughteringLine.php">Add Slaughtering Line</a></li>
					<li><a href="view_slaughteringLine.php">View Slaughtering Line </a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Slaughtering Line</h3>
...
$sql = "SELECT * FROM slaughterline WHERE name LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		if ($page > 1) 
			...
			$pagination.= "<a href=\"view_slaughteringLine.php?page=$prev&limit=$limit\" class=my_pagination >Previous</a>";
 ...
 ?> 
  ...
  <td> <?php echo $row['defeatheringMachine']; ?></td>
   ...
   <td> <?php echo $row['hockCutter']; ?></td>
    ...
    <td><a  href=print_slaughter_report.php?id="<?php echo $row['id'];?>" target="_blank">print</a>
    </td>
