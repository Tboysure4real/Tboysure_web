	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>Chiller Section Management</h3>
				<ul>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Chiller Section</h3>
...
$SQL = "SELECT DISTINCT(chilId) FROM  packagingchiller";

if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$SQL = "SELECT DISTINCT(chilId) FROM  packagingchiller WHERE chilId LIKE '%".$_POST['searchtxt']."%'";

}

	$tbl_name="packagingchiller";		//your table name
	...
	*/
	...
	$query = "SELECT COUNT(DISTINCT chiId) as num FROM $tbl_name";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$query = "SELECT COUNT(DISTINCT chilId) as num FROM packagingchiller WHERE chilId LIKE '%".$_POST['searchtxt']."%' ";
	...
	$targetpage = "view_chiller.php"; 	//your file name  (the name of this file)
	...
	$sql = "SELECT * FROM packagingchiller ORDER BY `id` ASC LIMIT $start, $limit ";
	
	if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$sql = "SELECT * FROM packagingchiller WHERE name LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		if ($page > 1) 
			...
			$pagination.= "<a href=\"view_chiller.php?page=$prev&limit=$limit\" class=my_pagination >Previous</a>";
		...
		{	
...

			{
				...
				if ($counter == $page)
					...
					$pagination.= "<a href=\"view_chiller.php?page=$counter&limit=$limit\" class=my_pagination>$counter</a>";					
...

		{
...

			{
...

				{
					...
					if ($counter == $page)
						...
						$pagination.= "<a href=\"view_evisceration.php?page=$counter&limit=$limit\" class=my_pagination>$counter</a>";					

				}

				$pagination.= "...";

				$pagination.= "<a href=\"view_chiller.php?page=$lpm1&limit=$limit\" class=my_pagination>$lpm1</a>";

				$pagination.= "<a href=\"view_chiller.php?page=$lastpage&limit=$limit\" class=my_pagination>$lastpage</a>";		
...

			{
				...
				$pagination.= "<a href=\"view_chiller.php?page=1&limit=$limit\" class=my_pagination>1</a>";

				$pagination.= "<a href=\"view_chiller.php?page=2&limit=$limit\" class=my_pagination>2</a>";
...
while($row = mysqli_fetch_array($result)) 
{
 ?> 
	...
	<td> <?php echo $row['id'];?></td>
      <td> <?php echo $row['chilId'];?></td>
      <td> <?php echo $row['mysqldate'];?></td>
   <td> <?php echo $row['chlorinDos']; ?></td>
    <td> <?php echo $row['pumpTank']; ?></td>   
  
   <td> <?php echo $row['floor']; ?></td>
   <td> <?php echo $row['wall']; ?></td>
  <td> <?php echo $row['screwChiller']; ?></td>

     <td> <?php echo $row['remark']; ?></td>


    <td><a  href=print_chiller.php?id="<?php echo $row['id'];?>" target="_blank">print</a>
    </td>
