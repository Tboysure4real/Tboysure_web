...
include_once("init.php");
	if(isset($_POST['secId'])){
					...
					$gump->validation_rules(array(
                        ...
                        'chemid' => 'required|max_len,100|min_len,3',
                        'chemName' => 'required|max_len,100|min_len,3',
                        'place'      =>    'required|max_len,100|min_len,3',
                        'mixer'     =>  'required|max_len,100|min_len,3',
                        'conc'    =>  'required|max_len,100|min_len,3',
                        'supervisor'           =>  'required|max_len,100|min_len,3',
                        'remark'           =>  'required|max_len,100|min_len,3',
                        
                        //'selected_date'         => 'required|max_len,100|min_len,3'
					
					));
				
					$gump->filter_rules(array(
                        'chemid'         => 'trim|sanitize_string|mysqli_escape',
                   'chemName'        => 'trim|sanitize_string|mysqli_escape',
                   'place'     => 'trim|sanitize_string|mysqli_escape',
                   'mixer'     => 'trim|sanitize_string|mysqli_escape',
                   'conc'            => 'trim|sanitize_string|mysqli_escape',
                   'supervisor'                  => 'trim|sanitize_string|mysqli_escape',
                   'remark'                => 'trim|sanitize_string|mysqli_escape'
                   //'selected_date'        => 'trim|sanitize_string|mysqli_escape'
                ));
					...
					if($validated_data === false) {
							...
							$callReading=($_POST['callReading']);
							$callTime2=($_POST['callTime2']);
							$callReading2=($_POST['callReading2']);
                            $callTime3=($_POST['callTime3']);
							$callReading3=($_POST['callReading3']);
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
			...
			//{
                /* 
                $quty = $quantity;
			$db->query("insert into stock_avail(name,quantity) values('$name[$i]','$quty[$i]')");
			echo "<br><font color=green size=+1 >New Stock Entry Inserted !</font>" ;
			*/
			//$db->query("insert into stock_details(stockid,name,quantity,supplier,cost,sell,0) //values('$autoid','$stock_name[$i]',0,'$supplier',$cost[$i],$sell[$i],0)");
        ...
        if(isset($_POST['secId'])){
			$db->query("insert into scalecalibration(section,secId,mysqldate,capacity,weight,callTime,callReading,callTime2,callReading2,callTime3,callReading3,calibrator,qc,manager,remark) 
            values('$section','$secId','$mysqldate','$capacity','$weight','$callTime','$callReading','$callTime2','$callReading2','$callTime3','$callReading3','$calibrator','$qc','$manager','$remark')"); 
			
         
                        $msg="Scale Calibration Added successfully Ref: ". $_POST['secId']."" ;
				header("Location: scalecalibration.php?msg=$msg");
            }
							}
                        }
...
<head>
	<meta charset="utf-8">
	<title> Add scale Calibration</title>
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
               ...
               <li><a href="chemicalUsageLog.php" class=" chem-tab">Chemical Log</a></li>
                ...
                <li><a href="scaleCalibration.php" class="sales-tab">Scale Caliberation</a></li>
				<li><a href="chillerSection.php" class="info-tab">Chiller</a></li>
                <li><a href="packagingSection.php" class="customers-tab">Packaging</a></li>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>Weighing Scale Calibration</h3>
				<ul>
					<li><a href="scaleCalibration.php">Add Scale Calibration</a></li>
					<li><a href="view_scaleCalibration.php">View Scale Calibration </a></li>
                    <li><a href="print_scaleCalibration_report1.php">Print Scale Calibration </a></li>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Add Scale Calibration</h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                               <?php
					  $max = $db->maxOfAll("id", "scaleCalibration");
					  $max=$max+1;
					  $autoid="SCAL ".$max."";
					  ...
					  ?>
					   <tr>
                      <td>Section Name:</td>
                      <td><input name="section" placeholder="ENTER SECTION NAME" type="text" id="section" maxlength="200"  class="round default-width-input" style="width:200px " /></td>
                      </tr>
                     <td>&nbsp; </td>
                     <tr><td>Sec. ID:</td>
                      <!--<td><input name="stockid" type="text" id="stockid" maxlength="200"  class="round default-width-input" style="width:130px" readOnly="true" value="<?php echo $autoid ?>" /></td>
                                        -->
                      <td><input name="secId" type="text" id="secId"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" style="width:130px"/></td>
                      ...
                      <td><span class="man">*</span>Scale Capacity:</td>
                      <td><input name="capacity" placeholder="ENTER SCALE CAPACITY" type="text" id="capacity"  maxlength="200"  class="round default-width-input"  /></td>
                     
                      <td><span class="man">*</span>Standard Weight:</td>
                      <td><input name="weight" placeholder="ENTER WEIGHT" type="text" id="weight" maxlength="200"  class="round default-width-input"  style="width:270px" value="<?php echo $reading; ?>" /></td>
                      ...
                      <td><span class="man">*</span>Call Time1:</td>
                      <td><input name="callTime" placeholder="ENTER CALL TIME" type="text" id="callTime"  maxlength="200"  class="round default-width-input"  /></td>
                      
                      <td><span class="man">*</span>Call Reading1:</td>
                      <td><input name="callReading" placeholder="ENTER CALL TIME" type="text" id="callReading"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo "100g/1.0kg"; ?>" /></td>
                    ...
                    <tr>
                      ...
                      <td><span class="man">*</span>Call Time2:</td>
                      <td><input name="callTime2" placeholder="ENTER CALL TIME" type="text" id="callTime2"  maxlength="200"  class="round default-width-input"  /></td>
                      
                      <td><span class="man">*</span>Call Reading2:</td>
                      <td><input name="callReading2" placeholder="ENTER CALL TIME" type="text" id="callReading3"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo "100g/1.0kg"; ?>" /></td>
                    ...
                    <tr>
                      ...
                      <td><span class="man">*</span>Call Time3:</td>
                      <td><input name="callTime3" placeholder="ENTER CALL TIME" type="text" id="callTime3"  maxlength="200"  class="round default-width-input"  /></td>
                      
                      <td><span class="man">*</span>Call Reading3:</td>
                      <td><input name="callReading3" placeholder="ENTER CALL TIME" type="text" id="callReading3"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo "100g/1.0kg"; ?>" /></td>
                    ...
                    <tr>
                         <td>Calibrated BY: </td>
                      <td><input name="calibrator" placeholder="ENTER THE CALIBRATOR's NAME" type="text" id="calibrator" maxlength="20"  class="round default-width-input" 
					  value="<?php echo $calibrator; ?>" /></td>
                        
                        <td>QA/QC: </td>
                      <td><input name="qc" placeholder="QC ATTESTATION"type="text" id="qc" maxlength="20"   class="round default-width-input" 
					  value="<?php echo $qc; ?>" /></td>
                        
                      <tr> <td>Manager </td>
                      <td><input name="manager" placeholder="MANAGER ATTESTATION" type="text" id="manager" maxlength="20"  class="round default-width-input" 
					  value="<?php echo $manager; ?>" /></td>
                      <td>Remark</td>
                      <td><textarea name="remark" placeholder="INPUT REMARK"cols="15" class="round full-width-textarea"><?php echo $remark; ?></textarea></td>
