<!-- TOP BAR -->
	<div id="top-bar">
		...
		<div class="page-full-width cf">
			...
			<li><a href="add_item.php" class="round button dark menu-tab image-left">Items</a></li>
			<li><a href="add_quality_report.php" class="round button dark menu-settings image-left">QA/QC</a></li>
			<li><a href="graph.php" class="round button dark menu-tab image-left">Graph</a></li>
			...
			<form action="#" method="POST" id="search-form" class="fr">
				<fieldset>
                                    <a href="logout.php" class="round button dark menu-logoff2 image-left" style="background-color: #cc0000">Log out</a>
				</fieldset>
			</form>
