		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					...
					<li><a href="print_evisceration.php">Print Evisceration Report</a></li>
...
$SQL = "SELECT DISTINCT(stockid) FROM  evisceration";

if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$SQL = "SELECT DISTINCT(stockid) FROM  evisceration WHERE stockid LIKE '%".$_POST['searchtxt']."%'";

}

	$tbl_name="evisceration";		//your table name
	...
	*/
	...
	$query = "SELECT COUNT(DISTINCT evisId) as num FROM $tbl_name";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$query = "SELECT COUNT(DISTINCT evisId) as num FROM evisceration WHERE name LIKE '%".$_POST['searchtxt']."%' ";
	...
	$targetpage = "view_evisceration.php"; 	//your file name  (the name of this file)
...
$sql = "SELECT * FROM evisceration WHERE name LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		if ($page > 1) 
			...
			$pagination.= "<a href=\"view_evisceration.php?page=$prev&limit=$limit\" class=my_pagination >Previous</a>";
...

		{
...

			{
				...
				$pagination.= "<a href=\"view_evisceration.php?page=$lpm1&limit=$limit\" class=my_pagination>$lpm1</a>";

				$pagination.= "<a href=\"view_evisceration.php?page=$lastpage&limit=$limit\" class=my_pagination>$lastpage</a>";		
...

			{
				...
				$pagination.= "<a href=\"view_evisceration.php?page=1&limit=$limit\" class=my_pagination>1</a>";

				$pagination.= "<a href=\"view_evisceration.php?page=2&limit=$limit\" class=my_pagination>2</a>";
...

			{
				...
				$pagination.= "<a href=\"$viewevisceration.php?page=1&limit=$limit\" class=my_pagination>1</a>";
