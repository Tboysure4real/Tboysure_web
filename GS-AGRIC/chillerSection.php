...
include_once("init.php");
	if(isset($_POST['chilId'])){
					$_POST = $gump->sanitize($_POST);
					$gump->validation_rules(array(

						'chilId' => 'required|max_len,100|min_len,3',                      
                        'chlorinDos' => 'required|max_len,100|min_len,3',
                        'pumpTank' => 'required|max_len,100|min_len,3',
                        'floor'      =>    'required|max_len,100|min_len,3',
                        'wall'     =>  'required|max_len,100|min_len,3',
                        'screwChiller'    =>  'required|max_len,100|min_len,3',
                        'remark'    =>  'required|max_len,100|min_len,3'
					));
				
					$gump->filter_rules(array(
                    'chilId'     => 'trim|sanitize_string|mysqli_escape',
                    'chlorinDos'         => 'trim|sanitize_string|mysqli_escape',
                   'pumpTank'        => 'trim|sanitize_string|mysqli_escape',
                   'floor'     => 'trim|sanitize_string|mysqli_escape',
                   'wall'     => 'trim|sanitize_string|mysqli_escape',
                   'screwChiller'            => 'trim|sanitize_string|mysqli_escape',
                  ...
                  $chilId   = "";
                   ...
                   $screwChiller  = ""; 
                    ...
                    if($validated_data === false) {
                            ...
                            $chilId=($_POST['chilId']);  
                            $date=($_POST['date']);                
							$chlorinDos=($_POST['chlorinDos']);
							$pumpTank=$_POST['pumpTank'];
                            $floor=($_POST['floor']);
							$wall=($_POST['shackleWasher']);
							$screwChiller=($_POST['screwChiller']);
                            $remark=($_POST['remark']);
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
        ...
        if(isset($_POST['chilId'])){
			$db->query("insert into packagingchiller(chilId,mysqldate,chlorinDos,pumpTank,floor,wall,screwChiller,remark) 
            values('$chilId','$mysqldate','$chlorinDos','$pumpTank','$floor','$wall','$screwChiller','$remark')"); 
		
                        $msg="chiller Section successfully Ref: ". $_POST['chilId']."" ;
				header("Location: chillerSection.php?msg=$msg");
            }
							}
                        }
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>Chiller Section</h3>
				<ul>
					<li><a href="chillerSection.php">Add Chiller Section</a></li>
					<li><a href="view_chiller.php">View Chiller Section </a></li>
				</ul>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Add Chiller Section</h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                               <?php
					  $max = $db->maxOfAll("id", "packagingchiller");
					  $max=$max+1;
					  $autoid="Chil ".$max."";
                      ...
                      <!--<td><input name="stockid" type="text" id="stockid" maxlength="200"  class="round default-width-input" style="width:130px" readOnly="true" value="<?php echo $autoid ?>" /></td>
                                        -->
                      <td><input name="chilId" type="text" id="chilId"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" /></td>
                    ...
                    <tr>
                      ...
                      <td>&nbsp; </td>
                       ...
                       <tr>
                      <td>ChlorinDos:</td>
                      <td><input name="chlorinDos" placeholder="" type="checkbox" id="chlorinDos" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
                      <td><input name="chlorinDos" placeholder="" type="checkbox" id="chlorinDos" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
                      </tr>
                      <tr>
                      <td>&nbsp; </td>
                      <td>&nbsp; </td>
                       ...
                       <tr>
                      <td>PumpTank:</td>
                      <td><input name="pumpTank" placeholder="" type="checkbox" id="pumpTank" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
                      <td><input name="pumpTank" placeholder="" type="checkbox" id="pumpTank" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
                      </tr>
                      <tr>
                      <td>&nbsp; </td>
                      <td>&nbsp; </td>
                      ...
                      <tr>
                      <td>Floor:</td>
                      <td><input name="floor" placeholder="" type="checkbox" id="floor" value="Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td>
                      <td><input name="floor" placeholder="" type="checkbox" id="floor" value="Not Clean" maxlength="200"  class="round default-width-input" style="width:120px " /></td></tr>
                     <td>&nbsp; </td>
                      <td>&nbsp; </td>
                      
                      <tr>
                     <td>Wall:</td>
                      <td><input name="wall" placeholder="" type="checkbox" id="wall" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
                      <td><input name="wall" placeholder="" type="checkbox" id="wall" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
                     <td>&nbsp; </td>
                     <td>&nbsp; </td>
                      
                      <tr>
                     <td>ScrewChiller:</td>
                      <td><input name="screwChiller" placeholder="" type="checkbox" id="screwChiller" maxlength="200" value="Clean"  class="round default-width-input" style="width:120px " /></td>
                      <td><input name="screwChiller" placeholder="" type="checkbox" id="scalder" maxlength="200"  value="Not Clean" class="round default-width-input" style="width:120px " /></td></tr>
                     <td>&nbsp; </td>
                     <td>&nbsp; </td>
                      
                     <tr>
      <td>Remark/Corrective action</td>
       <td><textarea name="remark" placeholder="REMARK "cols="15" class="round " style="width:200px height:150px"><?php echo $remark; ?></textarea></td>
       </tr>
      <td>&nbsp; </td>
      <td>&nbsp; </td>
       </tr>
