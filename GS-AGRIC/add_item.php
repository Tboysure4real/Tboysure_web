...
<head>
	<meta charset="utf-8">
	<title> Items Used For Production</title>
...
$(function() {
    document.getElementById('bill_no').focus();
        ...
        $("#supplier").blur(function()
            ...
            $("#dayCost").blur(function)
            {
                $.post()
                
                if(document.getElementById('unitCost').value!="" && document.getElementById('itemUsage').value!=""){
                document.getElementById('dayCost').value=parseFloat(document.getElementById('unitCost').value * parseFloat(document.getElementById('itemUsage').value));
...
if(document.getElementById('unitCost').value!="" && document.getElementById('itemUsage').value!=""){
    ...
    document.getElementById('dayCost').value="";
}
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                     ...
                     <tr><td>Item ID:</td>
                      <!--<td><input name="stockid" type="text" id="stockid" maxlength="200"  class="round default-width-input" style="width:130px" readOnly="true" value="<?php echo $autoid ?>" /></td>
                                        -->
                      <td><input name="itemId" type="text" id="itemId"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" style="width:130px"/></td>
                      ...
                      <td><input name="name" placeholder="ENTER ITEM NAME" type="text" id="name"  maxlength="200"  class="round default-width-input"  /></td>
                     
                      <td><span class="man">*</span>Unit Cost:</td>
                      <td><input name="unitCost" placeholder="ENTER WHERE CHEMICAL IS BEING APPLIED" type="text" id="unitCost" maxlength="200"  class="round default-width-input"  style="width:270px" value="<?php echo $unitCost; ?>" /></td>
                    ...
                    <tr>
                         <td>Opening Cost </td>
                      <td><input name="openingStock" placeholder="ENTER THE MIXER'S NAME" type="text" id="openingStock" maxlength="200"  class="round default-width-input" 
					  value="<?php echo $openingStock; ?>" /></td>
                        
                        <td>Supplier:</td>
                      <td><input name="supplier" placeholder="ENTER CHEMICAL CONC. PROPORTION"type="text" id="supplier" maxlength="200"   class="round default-width-input" 
					  value="<?php echo $supplier; ?>" /></td>
                        <tr>
                         
                      <tr> <td>Receiver:</td>
                      <td><input name="receiver" placeholder="ENTER THE MIXER'S NAME" type="text" id="receiver" maxlength="200"  class="round default-width-input" 
					  value="<?php echo $receiver; ?>" /></td>
                      
                      <td>Item Used </td>
                      <td><input name="itemUsage" placeholder="ENTER THE MIXER'S NAME" type="text" id="itemUsage" maxlength="200"  class="round default-width-input" 
					  value="<?php echo $itemUsage; ?>" /></td>
                                        </tr>
                      <td>&nbsp;</td><td>&nbsp;</td>

                        <tr>
                        <td>Transfer:</td>
                      <td><input name="transfer" placeholder="ENTER CHEMICAL CONC. PROPORTION"type="text" id="transfer" maxlength="200"   class="round default-width-input" 
					  value="<?php echo $transfer; ?>" /></td>
                      <td>Day Cost:</td>
                      <td><input name="dayCost" type="text" id="dayCost" maxlength="200" readonly="true"class="round default-width-input" 
					  value="<?php echo $dayCost; ?>" /></td>
                                        </tr>
                       <td>&nbsp;</td><td>&nbsp;</td>
                      <tr>
                      <td>Closing Stock:</td>
                      <td><input name="closingStock" type="text" id="closingStock" maxlength="200" readonly="true" class="round default-width-input" 
					  value="<?php echo $closingStock; ?>" /></td>
                      <td>Description</td>
                      <td><textarea name="description" placeholder="INPUT REMARK"cols="15" class="round round default-width-input"><?php echo $description; ?></textarea></td>
