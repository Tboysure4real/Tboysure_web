	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					<li><a href="housekeeping.php">Add Housekeeping Report</a></li>
					<li><a href="view_housekeeping.php">View Housekeeping Report</a></li>
...
$SQL = "SELECT DISTINCT(housId) FROM  housekeeping";

if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$SQL = "SELECT DISTINCT(housId	)FROM  housekeeping WHERE housId	 LIKE '%".$_POST['searchtxt']."%'";

}

	$tbl_name="housekeeping";		//your table name
	...
	*/
	...
	$query = "SELECT COUNT(DISTINCT housId) as num FROM $tbl_name";
if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{

$query = "SELECT COUNT(DISTINCT housId) as num FROM housekeeping WHERE name LIKE '%".$_POST['searchtxt']."%' ";
	...
	$targetpage = "view_housekeeping.php"; 	//your file name  (the name of this file)
...
$sql = "SELECT * FROM housekeeping WHERE name LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		if ($page > 1) 
			...
			$pagination.= "<a href=\"view_housekeeping.php?page=$prev&limit=$limit\" class=my_pagination >Previous</a>";
		...
		{	
...

			{
				...
				if ($counter == $page)
					...
					$pagination.= "<a href=\"view_housekeeping.php?page=$counter&limit=$limit\" class=my_pagination>$counter</a>";					
...

		{
...

			{
				...
				$pagination.= "<a href=\"view_housekeeping.php?page=$lpm1&limit=$limit\" class=my_pagination>$lpm1</a>";

				$pagination.= "<a href=\"view_housekeeping.php?page=$lastpage&limit=$limit\" class=my_pagination>$lastpage</a>";		
...

			{
				...
				$pagination.= "<a href=\"view_housekeeping.php?page=1&limit=$limit\" class=my_pagination>1</a>";

				$pagination.= "<a href=\"view_housekeeping.php?page=2&limit=$limit\" class=my_pagination>2</a>";
		...
		if ($page < $counter - 1) 
			...
			$pagination.= "<a href=\"view_housekeeping.php?page=$next&limit=$limit\" class=my_pagination>Next</a>";
