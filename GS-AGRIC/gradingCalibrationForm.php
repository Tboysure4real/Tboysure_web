...
include_once("init.php");
	if(isset($_POST['graId'])){
					$_POST = $gump->sanitize($_POST);
					$gump->validation_rules(array(

						'graId' => 'required|max_len,100|min_len,3',                      
                    ...
                    'graId'     => 'trim|sanitize_string|mysqli_escape',
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
        ...
        if(isset($_POST['slauId'])){
			$db->query("insert into slaughterline(slauId,stunner,bleedingTrough,rollerConveyor,shackleWasher,scalder,defeatheringMachine,headPuller,killingLine,shackles,feetUnloader,hockCutter,remark) 
            values('$slauId','$stunner','$bleedingTrough','$rollerConveyor','$shackleWasher','$scalder','$defeatheringMachine','$headPuller','$killingLine','$shackles','$feetUnloader','$hockCutter','$remark')"); 
...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<a href="#" id="company-branding-medium" class="fr"><img src="<?php if(isset($_SESSION['logo'])) { echo "upload/".$_SESSION['logo'];}else{ echo "upload/posnic.png"; } ?>" alt="Point of Sale" /></a>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<h3>Grading Line Management</h3>
				<ul>
					<li><a href="gradingCalibrationForm.php">Add Grading Line Form</a></li>
					<li><a href="gradingCalibrationForm">View Grading Line Form </a></li>
				</ul>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Add Grading Line Form</h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
            ...
            <div class="mytable_row ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                               <?php
					  $max = $db->maxOfAll("id", "gradingcalibration");
					  $max=$max+1;
					  $autoid="Grad ".$max."";
                      ...
                      <tr>
                      <td>Grad ID:</td>
                      <td><input name="gradId" type="text" id="slauId"  maxlength="200"  class="round default-width-input" readOnly="true" value="<?php echo $autoid; ?>" /></td>
                     ...
                     <tr>
                      <td>Point 1</td>
                       <td style="margin:20px">Point 2</td>
                        <td style="margin:200px">Point 3</td>
                        <td>Point 4</td>
                       
                      <td><label for="point5" style="margin:20px>Point 5</td>
                       <td style="marging:200px">Point 6</td>
                        <td>Point 7</td>
                        <td>Point 8</td>
                                        </tr>
                     <!-- <tr>
                      <td><input name="point1" placeholder="" type="checkbox" id="point1" value="" maxlength="200"  class="round default-width-input" style="width:200px " /></td>
                      </tr>
                      <tr>
                      <td>&nbsp; </td>
                      <td>&nbsp; </td>
                    ...
                    <td>Remark/Corrective action</td>
                      <td><textarea name="remark" placeholder="ENTER REMARKS "cols="15" class="round full-width-textarea" style="width:400px "><?php echo $address; ?></textarea></td>
                      </tr>
                     <td>&nbsp; </td>
                     <td>&nbsp; </td>
                                        -->
